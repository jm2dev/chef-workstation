...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "josemiguel-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/optimates"
  #   chef.validation_client_name = "optimates-validator"
  #   chef.validation_key_path = ".chef/optimates-validator.pem"
  # end
end
